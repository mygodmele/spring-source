...
public class AnnotatedBeanDefinitionReader {
	...
	<T> void doRegisterBean(Class<T> beanClass, @Nullable Supplier<T> instanceSupplier, @Nullable String name,
		...
		// 配置类为AnnotatedGenericBeanDefinition类型的DB
		...
		// 判断配置类上是否有Lazy Primary DependsOn Role Description注解
		// 存在则set到属性中
		AnnotationConfigUtils.processCommonDefinitionAnnotations(abd);

		// 单独注册的时候提供注解参数,需要直接实例化Reader对象来调用，可参考Test
		if (qualifiers != null) {
		...
		// 放入到DefaultListableBeanFactory.beanDefinitionMap中
